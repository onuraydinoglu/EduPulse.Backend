...
public interface IClubMemberService
{
    ...
    Task<Result> CreateAsync(CreateClubMemberDto dto, string? roleName, string? schoolId, string? teacherId);

    Task<Result> DeleteAsync(string id, string? roleName, string? schoolId, string? teacherId);
}